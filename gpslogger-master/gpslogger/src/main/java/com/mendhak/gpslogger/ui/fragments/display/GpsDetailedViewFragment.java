...
public class GpsDetailedViewFragment extends GenericViewFragment {
    ...
    private void clearDisplay() {
        ...
        TextView txtSatellites = (TextView) rootView.findViewById(R.id.detailedview_satellites_text);
        txtSatellites.setTextColor(Color.parseColor("#FFFFFF"));
        ...
        txtStill.setTextColor(Color.parseColor("#FFFFFF"));
        tvLatitude.setText("");
        tvLongitude.setText("");
        tvDateTime.setText("");
        tvAltitude.setText("");
